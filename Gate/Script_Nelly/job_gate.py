...
#number_jobs=20
def run_simulation_old(primaries_per_proj, number_jobs):
        ...
        for folder in patientfolders:
            ...
            try:
                ...
                try:
                    ...
                    count_projections.update_mac(primaries_per_proj,number_jobs)

                    # run the simulations
                    #gatecommand_primary = 'Gate mac/primary-patient.mac'
                    gatecommand_primary = 'gate_split_and_run.py -j 1 mac/primary-patient.mac'
                    os.system(gatecommand_primary)
                    gatecommand_scatter = f'gate_split_and_run.py -j {number_jobs} mac/scatter-patient.mac'
...
def run_simulation(primaries_per_proj, number_jobs):
...
if __name__ == "__main__":
    ...
    run_simulation(prim_per_proj,number_jobs)
