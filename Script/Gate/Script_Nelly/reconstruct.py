...
def reconstruct(primaries_per_proj,num_jobs):
    ...
    for simulation in glob.glob('./Simulations/*'):
        ...
        try:
            ...
            #copy_directory = f'{images_folder}/{os.path.basename(simulation)}'
            copy_directory = f'../../cbct_images/{os.path.basename(simulation)}'
            ...
            print(f'Error for patient {simulation}: {e}')
